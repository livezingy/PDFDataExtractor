...
**优点**：无需安装，快速试用PDF表格提取  
**限制**：
- 仅支持PDF表格提取（PDFPlumber/Camelot）
- **图像表格检测功能（PaddleOCR/Transformer）需要在本地/服务器部署**
...
**注意**：图像表格检测功能需要在**本地或服务器部署**，Streamlit Cloud不支持。

1. **上传文件**：选择图像文件
2. **选择引擎**：选择"Detection Engine"
   - **PaddleOCR**（推荐）：适合中文文档，支持表格检测和结构识别
   - **Transformer**：适合复杂表格和英文文档
